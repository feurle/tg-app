...
class CustomerServiceTest {
    ...
    void createCustomer_savesAndReturnsCustomer() {
        Customer customer = customerService.createCustomer(
                ...
                "Hauptstr. 1", "Berlin", "BE", "10115", "Germany"
        );
    ...
    void getAllCustomers_returnsAllCustomers() {
        customerService.createCustomer("Max", "Müller", "max@example.com", "+49123456789",
                "Hauptstr. 1", "Berlin", "BE", "10115", "Germany");
        customerService.createCustomer("Lisa", "Schmidt", "lisa@example.com", "+49987654321",
                "Königstr. 2", "München", "BY", "80333", "Germany");
    ...
    void updateCustomer_updatesAndReturnsCustomer() {
        ...
        Customer updated = customerService.updateCustomer(
                created.getId(), "Maximilian", "Mueller", "maximilian@example.com", "+49999999999",
                "Friedrichstr. 100", "Berlin", "BE", "10117", "Germany"
        );
